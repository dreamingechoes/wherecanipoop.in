...
export default function App() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("https://nocodeform.io/f/6813d91ce0a0bd8d89bb1933", {
        method: "POST",
        headers: {
        ...
        <div className="max-w-6xl w-full grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-700 mb-6">
              Find clean, nearby restrooms instantly with Where Can I Poop In?—the fun, fast, and reliable bathroom finder app with real reviews and ratings.
            </p>
          ...
          <div className="hidden md:block">
            <img src="/logo.png" alt="Where Can I Poop In?" className="w-full max-w-md mx-auto" />
          </div>
        </div>
      </div>
